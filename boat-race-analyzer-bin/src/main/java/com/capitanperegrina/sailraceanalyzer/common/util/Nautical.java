package com.capitanperegrina.sailraceanalyzer.common.util;
...
public class Nautical {
	...
	public static final String NOMBRE_PIN_SALIDA = "Pin";
	public static final String NOMBRE_COMITE_SALIDA = "CR";
	public static final String NOMBRE_MORRAZAN = "Morrazán";
	public static final String NOMBRE_PIN_LLEGADA = "B.Llegada";
	public static final String NOMBRE_COMITE_LLEGADA = "CR Llegada";
