...
public class LineImpl extends MapElementImpl implements Line {

	private static final long serialVersionUID = -2986129642357285810L;
	...
	public LineImpl(double lat1, double lon1, double lat2, double lon2, String name) {
		Point a = new PointImpl(lat1, lon1);
		Point b = new PointImpl(lat2, lon2);
		this.point1 = a;
		this.point2 = b;
	...
	public LineImpl(Point p1, Point p2, String name) {
		this.point1 = p1;
		this.point2 = p2;
		this.name = name;
    	this.type = MapElementType.LINE;
	...
	public Line rotate(double angulo, Point anchor) {
		return new LineImpl( this.point1.rotate(angulo, anchor), this.point2.rotate(angulo, anchor) );
	}	
	...
	public String buildString() {
		...
		ret.append(this.point1.buildString() + " -> " + this.point2.buildString());
		return ret.toString();
	}
