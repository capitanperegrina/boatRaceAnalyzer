...
public class Nautical {
	...
	public static final String NOMBRE_MORRAZAN = "Morrazán";
	public static final String NOMBRE_PIN_LLEGADA = "Pin Llegada";
	public static final String NOMBRE_CR_LLEGADA = "CR Llegada";
	...
	// IMAGENES BASE64
	// //////////////////////////////////////////////////////////////////////////////////////////
	public static String getBalizaImageBase64(Integer tipoBaliza) {
		return iconosHtmlString.get(tipoBaliza);
	}

	public static Integer getTipoPunto(double v) {
		if (v <= 0) {
	...
	public static double fromKilometers(double meters) {
	...
	public static double toMiles(double nm) {
	...
	public static String formatCordinate(double c) {
		DecimalFormat formato = new DecimalFormat("0.000000");
		return StringUtils.leftPad(formato.format(c), 10, ' ');
	}

	public static String formatCordinate(BigDecimal c) {
		if ( c==null ) {
			return "";
		}
		DecimalFormat formato = new DecimalFormat("0.000000");
	...
	public static String formatCourse(double r) {
		DecimalFormat formato = new DecimalFormat("000");
		return StringUtils.leftPad(formato.format(r), 4, ' ');
	}
	
	public static String formatCourse(BigDecimal r) {
		if ( r==null ) {
			return "";
		}
		DecimalFormat formato = new DecimalFormat("000");
	...
	public static String formatDistance(BigDecimal d) {
		if ( d==null ) {
			return "";
		}
